...
class TestLoginHappyPath:
    ...
    def test_successful_login(self, login_page, random_user):
    ...
    def test_invalid_credentials_error(self, login_page):
        """1.2 Error message with invalid credentials"""
        invalid_email = "nonexistent@example.com"
        invalid_password = "WrongPassword123!"
        login_page.page.context
    ...
    def test_empty_fields_validation(self, login_page):
    ...
    def test_registration_link(self, login_page):
